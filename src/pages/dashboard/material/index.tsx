        ...
        <section>
          <div className="flex justify-between items-center">
            ...
            <div className="relative flex justify-center items-center">
              ...
              <Input
                ...
                className="sm:w-96 w-full py-2 rounded-md pl-12 outline-none"
              />
          ...
          <div className="flex justify-between items-center my-5">
            <div className="relative inline-block w-40">
              <select className="block appearance-none w-full bg-white border border-gray-300 text-gray-700 py-2 px-3 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
